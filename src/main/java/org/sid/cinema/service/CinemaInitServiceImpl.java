...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initVilles() {
		Stream.of("Casablanca", "Rabat","Marrackech", "Tanger").forEach(nameVille->{
	...
	@Override
	public void intiCategories() {
		Stream.of("Actions","Crime","Horror").forEach(cat->{
	...
	public void initFilms() {
	  ...
	  Stream.of("Avengers","Hush","Baby driver").forEach(titreFilm->{
		  Film film = new Film();
